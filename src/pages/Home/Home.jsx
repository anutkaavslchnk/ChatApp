            ...
            <div className={s.container_whole}>
              ...
              <div className={s.cont_icons_txt}>
                <div className={s.cont_txt}>
                  <p className={s.hero_title}>
                    Connect instantly. Chat freely. Stay close
                  </p>
                  <p className={s.hero_txt}>no matter the distance!</p>
                  <button className={s.btn_get_started} onClick={handleClick}>
                    Get started
                  </button>
                </div>

                <div className={s.cont_icons_adaptive}></div>
              </div>
